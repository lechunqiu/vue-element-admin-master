  ...
  <div class="app-container">
    <div class="filter-container">
      <div class="bg_white serchadd">
        ...
        <el-button class="filter-item right ggcxtjbtn add_btn" @click="dialogVisible = true" style="margin-left: 10px;"  type="primary" icon="el-icon-edit">创建品牌</el-button>
      </div>
      ...
      <el-table :data="tableData" border style="width: 100%">
        ...
        <el-table-column align='center' prop="recommend" label="热门推荐" width="180">
        </el-table-column>
