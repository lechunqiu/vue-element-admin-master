  ...
  <div class="app-container">
    <div class="filter-container">
      <div class="bg_white serchadd">
        ...
        <el-button class="filter-item right ggcxtjbtn add_btn" style="margin-left: 10px;" @click="dialogVisible = true"  type="primary" icon="el-icon-edit">创建分类</el-button>
      </div>
      ...
      <el-dialog title="创建店铺商品分类" :visible.sync="dialogVisible" width="30%" :before-close="handleClose">
