      ...
      <el-row :gutter="20">
        <el-col :xs="24" :sm="24" :md="12" :lg="8" :xl="6" v-for='item in gwcsps' >
          <div class="gwcsp_box box_shadow">
              <div class="spcheck">
                <p class="ptsmbh">商品编码：{{item.comcode}} <span class="right color_nine">{{item.sfsj}}</span> </p>
              </div>
              ...
              <div class="comimgtitie">
                  ...
                  <div class="comtitle right">
                      ...
                      <p class="color_six">商品详情：{{item.details}}</p>
                  </div>
                  <div class="clear">
                  </div>
              </div>
              <hr>
              <div class="spamount">
                  <span class="amtspan">共 {{item.amount}}种商品</span>

                  <el-button type='primary' class="right"  style='margin-left:10px' >创建商品
                  </el-button>
                  <el-button type='primary' class="right" >查看
                  </el-button>
                  <div class="clear">
